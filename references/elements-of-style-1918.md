<!--
Source: William Strunk, Jr., "The Elements of Style" (1918).
Public domain in the United States (published before 1929).
Converted to Markdown from the PDF at https://daoyuan14.github.io/elos.pdf.
The text is unchanged except for layout; the PDF's modern publisher's blurb is left out.
-->
...
| 7 When I am in the country, I wish to vegetate like the country, which is the gist of all that can be said upon the matter. | 6-7 The same reason as stated by Hazlitt. |
...
| 9 And so long as a man is reasoning he cannot surrender himself to that fine intoxication that comes of much motion in the open air, that begins in a sort of dazzle and sluggishness of the brain, and ends in a peace that passes comprehension. | 9 Final statement of the fourth reason, in language amplified and heightened to form a strong conclusion. |
...
| 6 They undertook to study in the past the physiology of nations, and hoped by applying the experimental method on a large scale to deduce some lessons of real value about the conditions on which the welfare of society mainly depend. | 6 Conclusion: an important consequence of the new conception of history. |
