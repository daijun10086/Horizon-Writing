...
- When text discusses a figure or table, explain it in three steps. First say what it shows: the axes and units, what each marker or bar stands for, the baseline, and the one observation that matters. Then explain why the data looks that way, and finally say what it implies. "Figure 7 shows the results" is not an explanation.
